...
class Employee(models.Model):
    ...
    emp_pic = models.CharField(db_column='Emp_Pic', max_length=568)  # Field name made lowercase.
    address = models.CharField(db_column='Address', max_length=220, blank=True, null=True)  # Field name made lowercase.
    deignation = models.CharField(db_column='Deignation', max_length=40, blank=True, null=True)  # Field name made lowercase.
